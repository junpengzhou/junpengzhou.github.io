...
![img](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/007S8ZIlly1gg9kuge8ovj32150tt7cd.jpg)
...
![jvm-framework](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/0082zybply1gc6fz21n8kj30u00wpn5v.jpg)
...
![jvm-pc-counter](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/0082zybply1gc5kmznm1sj31m50u0wph.jpg)
...
![img](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/0082zybply1gc9lezaxrbj319v0u0k4w.jpg)
...
- 一些附加信息
  ...
  ![jvm-stack-frame](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/0082zybply1gc8tjehg8bj318m0lbtbu.jpg)
...
- **栈帧中的局部变量表中的槽位是可以重用的**，如果一个局部变量过了其作用域，那么在其作用域之后申明的新的局部变量就很有可能会复用过期局部变量的槽位，从而**达到节省资源的目的**。（下图中，this、a、b、c 理论上应该有 4 个变量，c 复用了 b 的槽）
  ...
  ![img](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/0082zybply1gc9s12g5wlj31li0owdm9.jpg)
...
- 在 Java 源文件被编译到字节码文件中时，所有的变量和方法引用都作为**符号引用**（Symbolic Reference）保存在 Class 文件的常量池中。比如：描述一个方法调用了另外的其他方法时，就是通过常量池中指向方法的符号引用来表示的，那么**动态链接的作用就是为了将这些符号引用转换为调用方法的直接引用**
  ...
  ![jvm-dynamic-linking](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/0082zybply1gca4k4gndgj31d20o2td0.jpg)
...
### 3.1 本地方法接口（Native Method Interface）
...
- 元空间（JDK1.8 之前叫永久代）：像一些方法中的操作临时对象等，JDK1.8 之前是占用 JVM 内存，JDK1.8 之后直接使用物理内存
  ...
  ![JDK7](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/00831rSTly1gdbr7ek6pfj30ci0560t4.jpg)
...
![img](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/007S8ZIlly1gg06065oa9j31kw0u0q69.jpg)
...
- **方法区（method area）只是JVM 规范中定义的一个概念**，用于存储类信息、常量池、静态变量、JIT编译后的代码等数据，并没有规定如何去实现它，不同的厂商有不同的实现。而**永久代（PermGen）是 Hotspot虚拟机特有的概念， Java8 的时候又被元空间**取代了，永久代和元空间都可以理解为方法区的落地实现。
...
![img](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/007S8ZIlly1gg9i91ze2gj320i0riahe.jpg)
...
![img](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/007S8ZIlly1gg04ve34c2j30z00u0dp7.jpg)
