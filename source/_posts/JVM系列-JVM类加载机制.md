...
![img](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/java_jvm_classload_2.png)
...
![img](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/java_jvm_classload_1.png)
...
![img](https://junpengzhou-1305658609.cos.ap-nanjing.myqcloud.com/blog/java_jvm_classload_3.png)
...
`启动类加载器`: Bootstrap ClassLoader，负责加载存放在JDK\jre\lib(JDK代表JDK的安装目录，下同)下，或被-Xbootclasspath参数指定的路径中的，并且能被虚拟机识别的类库(如rt.jar，所有全局限定名为java.*开头的类均被BootstrapClassLoader加载)。启动类加载器是无法被Java程序直接引用的。
